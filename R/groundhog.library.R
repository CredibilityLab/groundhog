...
#'
#'@param pkg character string with name of target package to install, 
#'need not be in quotes.
#'@param date character string, or date value, with the date which determines the 
#'version of the package, and all dependencies, to be installed. It's in yyyy-mm-dd format.
#'@param quiet.install a logical, defaults to TRUE. When set to FALSE displays
...
#'@param current.deps character vector with dependencies that, if needed, will be 
