  ...
  # Add msg if R mismatch and recent enough for groundhog
	  if (rv$r.using.majmin != rv$r.need.majmin & date > "2014-09-18") {
		msg <- c(
		  ...
		  "> Moreover, some scripts will give different results in different versions of R, thus you may want \n",
		  "  to run this script with R-", rv$r.need.full, "  if you don't obtain expected results.\n",
